...
Assert-Contains -Name "CI runs documentation language link checks" -Text $ci -Pattern '\.\\tests\\docs-language-links\.ps1'
Assert-Contains -Name "CI runs configuration schema checks" -Text $ci -Pattern '\.\\tests\\config-schema\.ps1'
