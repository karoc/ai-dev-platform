...
- **[Getting Started](getting-started.md)** ([简体中文](zh-CN/getting-started.md)): first-time setup walkthrough — from nothing to a running development VM in ~30-70 minutes.
